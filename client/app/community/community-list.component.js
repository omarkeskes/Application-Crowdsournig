...
var CommunityListComponent = (function () {
    function CommunityListComponent(etudiantservice) {
        var _this = this;
        this.etudiantservice = etudiantservice;
        console.log("started");
        this.etudiantservice.getStudents().subscribe(function (students) { return _this.students = students; });
        console.log(this.students);
    }
    return CommunityListComponent;
}());
CommunityListComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
